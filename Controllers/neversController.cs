...
namespace modarres_sms.Controllers
{
    ...
    public class neversController : Controller
    {
        ...
        public neversController(modarres_smsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //ViewBag.khata = khata_list;
              return _context.never != null ? 
                          ...
                          Problem("Entity set 'modarres_smsContext.never'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'modarres_smsContext.never'  is null.");
            }
            var never = await _context.never.FindAsync(id);
            if (never != null)
            {
